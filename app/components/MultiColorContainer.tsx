...
export default function MultiColorContainer({
  ...
  return (
    <div className="MultiColorContainer border-one multi-color-container bg-accent-one my-0 rounded-[60px] hover:shadow-[0_0_0_60px_var(--color-accent-one)] lg:my-10">
